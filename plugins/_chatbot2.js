let handler = m => m 
 ...
     conn.reply(m.chat,` استرجل ياعم`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
  
 } 
  
 if (/^الحمدلله$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, ` ادام الله حمدك قول امين ياورع `, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
     conn.reply(m.chat, ` منور بكشاف ✨💜 `, m) //wm, null, [['Menu', '#menu']], m) botones :V 
